...
namespace Server.Data.Migrations
{
    ...
    [Migration("20260912025557_AddLikeModule")]
    partial class AddLikeModule
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Server.Models.UserLike", b =>
                {
            ...
            modelBuilder.Entity("Server.Models.UserLike", b =>
                {
                    b.HasOne("Server.Models.AppUser", "SourceMember")
                        .WithMany("LikedMembers")
                        .HasForeignKey("SourceMemberId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Server.Models.AppUser", "TargetMember")
